...
namespace Jouzeyu\Weather\Tests;

use Jouzeyu\Weather\Exceptions\InvalidArgumentException;
use Jouzeyu\Weather\Weather;
use PHPUnit\Framework\TestCase;
use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Psr7\Response;
use Mockery\Matcher\AnyArgs;
use Jouzeyu\Weather\Exceptions\HttpException;
